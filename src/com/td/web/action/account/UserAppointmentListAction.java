 ...
 */
@Component
public class UserAppointmentListAction extends BasePaginatedAction {
  ...
  public Resolution pre() {
    ...
    return new ForwardResolution("/pages/account/user/userAppointments.jsp");
  }

  public Resolution updateAppointmentStatus() {
    getAppointmentService().updateAppointmentStatus(appointmentId, appStatus);

    return new RedirectResolution(UserAppointmentListAction.class);
  }

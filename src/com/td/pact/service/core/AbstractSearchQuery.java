...
import com.td.pact.query.SortOrder;
...
public abstract class AbstractSearchQuery implements SearchQuery {
  ...
  protected abstract String getBaseQuery(boolean isCountQuery);
  ...
  public String getQueryString(boolean isCountQuery) {
    StringBuilder queryStr = new StringBuilder(getBaseQuery(isCountQuery));
